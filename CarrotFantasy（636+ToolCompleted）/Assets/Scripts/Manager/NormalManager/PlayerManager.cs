...
public class PlayerManager
{
    ...
    public PlayerManager()
    {
        ...
        unLockedNormalModelLevelList = new List<Stage>()
        {
            ...
            new Stage(10,3,new int[]{ 7,2,1},false,0,3,2,true,false),
            new Stage(10,2,new int[]{ 8,2},false,0,4,2,true,false),
            new Stage(10,3,new int[]{ 7,2,1},false,0,5,2,true,false),
        };
